...
|
"""
"—••÷𝐂𝐨𝐩𝐲𝐫𝐢𝐠𝐡𝐭 (𝐂) 𝟐𝟎𝟐𝟏 𝗛𝘆𝗽𝗲𝗩𝗼𝗶𝗱𝗦𝗼𝘂𝗹 | 𝗛𝘆𝗽𝗲𝗩𝗼𝗶𝗱𝗟𝗮𝗯 | 𝗛𝘆𝗽𝗲𝗩𝗼𝗶𝗱𝘀  ================== MAIN IMPORT AREA ============= —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—÷••—"
'''
.................................................................
Builtin import area
.................................................................
...
ӼɛӼօ = "[•𝗡𝗢𝗥𝗗Σ𝗗•🎧](https://t.me/hypevoidbot) **by** [🔺ΉYPΣ VӨID LΛB](https://t.me/hypevoidbot)\n🕊==========================🕊\n\n"
...
**{DYNO}stream**
•♪ 𝘙𝘦𝘱𝘭𝘺 𝘵𝘰 𝘢𝘶𝘥𝘪𝘰 𝘧𝘪𝘭𝘦 𝘵𝘰 𝘱𝘭𝘢𝘺/𝘲𝘶𝘦𝘶𝘦 𝘵𝘰 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}stream**
•♪ 𝘜𝘴𝘦 𝘵𝘰 𝘤𝘩𝘦𝘤𝘬𝘰𝘶𝘵 𝘵𝘩𝘦 𝘱𝘭𝘢𝘺𝘭𝘪𝘴𝘵 𝘰𝘧 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}ping**   
•♪ 𝘊𝘩𝘦𝘤𝘬 𝘵𝘩𝘦 𝘱𝘪𝘯𝘨 𝘴𝘵𝘢𝘵𝘶𝘴 𝘰𝘧 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}license**
•♪ 𝘊𝘩𝘦𝘤𝘬 𝘭𝘪𝘤𝘦𝘯𝘴𝘦 𝘰𝘧 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}yt**
•♪ __Direct youtube music download and play with 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.__
"""
...
**{DYNO}norded** 
•♪ 𝘊𝘩𝘦𝘤𝘬 𝘸𝘩𝘦𝘳𝘦 𝘪𝘴 𝘵𝘩𝘦 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝘶𝘴𝘦𝘳𝘣𝘰𝘵 𝘱𝘭𝘶𝘨𝘨𝘦𝘥.
**{DYNO}plug**   
•♪ —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝘑𝘰𝘪𝘯 𝘨𝘳𝘰𝘶𝘱 𝘷𝘰𝘪𝘤𝘦 𝘤𝘩𝘢𝘵.
**{DYNO}unplug** 
•♪ 𝘓𝘦𝘢𝘷𝘦 𝘵𝘩𝘦 𝘨𝘳𝘰𝘶𝘱 𝘷𝘰𝘪𝘤𝘦 𝘤𝘩𝘢𝘵 𝘸𝘩𝘦𝘳𝘦 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝘸𝘢𝘴 𝘱𝘭𝘢𝘺𝘪𝘯𝘨.
**{DYNO}end**    
...
**{DYNO}temp**   
•♪ 𝘊𝘭𝘦𝘢𝘯 𝘵𝘦𝘮𝘱 𝘢𝘶𝘥𝘪𝘰 𝘧𝘪𝘭𝘦𝘴 𝘪𝘯 𝘴𝘦𝘳𝘷𝘦𝘳 𝘰𝘧 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
"""
...
**{DYNO}shutdown**
•♪ 𝘛𝘶𝘳𝘯 𝘰𝘧𝘧 𝘏𝘌𝘙𝘖𝘒𝘜 𝘋𝘺𝘯𝘰 𝘧𝘰𝘳 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}restart**
•♪ 𝘙𝘦𝘣𝘰𝘰𝘵 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝘮𝘢𝘯𝘶𝘢𝘭𝘭𝘺 𝘪𝘯 𝘏𝘌𝘙𝘖𝘒𝘜.
**{DYNO}usage**  
•♪ 𝘍𝘪𝘯𝘥 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝘏𝘌𝘙𝘖𝘒𝘜 𝘥𝘺𝘯𝘰 𝘶𝘴𝘢𝘨𝘦
"""
...
"""
"""
𝐑𝐞𝐩𝐥𝐲 𝐭𝐨 𝐚𝐮𝐝𝐢𝐨 𝐟𝐢𝐥𝐞 𝐭𝐨 𝐩𝐥𝐚𝐲/𝐪𝐮𝐞𝐮𝐞 𝐭𝐨 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐔𝐬𝐞 𝐭𝐨 𝐜𝐡𝐞𝐜𝐤𝐨𝐮𝐭 𝐭𝐡𝐞 𝐩𝐥𝐚𝐲𝐥𝐢𝐬𝐭 𝐨𝐟 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐂𝐡𝐞𝐜𝐤 𝐭𝐡𝐞 𝐩𝐢𝐧𝐠 𝐬𝐭𝐚𝐭𝐮𝐬 𝐨𝐟 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️. 
𝐂𝐡𝐞𝐜𝐤 𝐥𝐢𝐜𝐞𝐧𝐬𝐞 𝐨𝐟 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐂𝐡𝐞𝐜𝐤 𝐰𝐡𝐞𝐫𝐞 𝐢𝐬 𝐭𝐡𝐞 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝐮𝐬𝐞𝐫𝐛𝐨𝐭 𝐩𝐥𝐮𝐠𝐠𝐞𝐝
𝐉𝐨𝐢𝐧 𝐠𝐫𝐨𝐮𝐩 𝐯𝐨𝐢𝐜𝐞 𝐜𝐡𝐚𝐭.
𝐋𝐞𝐚𝐯𝐞 𝐭𝐡𝐞 𝐠𝐫𝐨𝐮𝐩 𝐯𝐨𝐢𝐜𝐞 𝐜𝐡𝐚𝐭 𝐰𝐡𝐞𝐫𝐞 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️. 𝐰𝐚𝐬 𝐩𝐥𝐚𝐲𝐢𝐧𝐠.
...
𝐂𝐥𝐞𝐚𝐧 𝐭𝐞𝐦𝐩 𝐚𝐮𝐝𝐢𝐨 𝐟𝐢𝐥𝐞𝐬 𝐢𝐧 𝐬𝐞𝐫𝐯𝐞𝐫 𝐨𝐟 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐓𝐮𝐫𝐧 𝐨𝐟𝐟 𝐇𝐄𝐑𝐎𝐊𝐔 𝐃𝐲𝐧𝐨 𝐟𝐨𝐫 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐑𝐞𝐛𝐨𝐨𝐭 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝐦𝐚𝐧𝐮𝐚𝐥𝐥𝐲 𝐢𝐧 𝐇𝐄𝐑𝐎𝐊𝐔.
𝐅𝐢𝐧𝐝 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝐇𝐄𝐑𝐎𝐊𝐔 𝐝𝐲𝐧𝐨 𝐮𝐬𝐚𝐠𝐞

𝗥𝗲𝗽𝗹𝘆 𝘁𝗼 𝗮𝘂𝗱𝗶𝗼 𝗳𝗶𝗹𝗲 𝘁𝗼 𝗽𝗹𝗮𝘆/𝗾𝘂𝗲𝘂𝗲 𝘁𝗼 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗨𝘀𝗲 𝘁𝗼 𝗰𝗵𝗲𝗰𝗸𝗼𝘂𝘁 𝘁𝗵𝗲 𝗽𝗹𝗮𝘆𝗹𝗶𝘀𝘁 𝗼𝗳 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗖𝗵𝗲𝗰𝗸 𝘁𝗵𝗲 𝗽𝗶𝗻𝗴 𝘀𝘁𝗮𝘁𝘂𝘀 𝗼𝗳 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗖𝗵𝗲𝗰𝗸 𝗹𝗶𝗰𝗲𝗻𝘀𝗲 𝗼𝗳 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗖𝗵𝗲𝗰𝗸 𝘄𝗵𝗲𝗿𝗲 𝗶𝘀 𝘁𝗵𝗲 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝘂𝘀𝗲𝗿𝗯𝗼𝘁 𝗽𝗹𝘂𝗴𝗴𝗲𝗱
𝗝𝗼𝗶𝗻 𝗴𝗿𝗼𝘂𝗽 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁.
𝗟𝗲𝗮𝘃𝗲 𝘁𝗵𝗲 𝗴𝗿𝗼𝘂𝗽 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁 𝘄𝗵𝗲𝗿𝗲 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝘄𝗮𝘀 𝗽𝗹𝗮𝘆𝗶𝗻𝗴.
...
𝗖𝗹𝗲𝗮𝗻 𝘁𝗲𝗺𝗽 𝗮𝘂𝗱𝗶𝗼 𝗳𝗶𝗹𝗲𝘀 𝗶𝗻 𝘀𝗲𝗿𝘃𝗲𝗿 𝗼𝗳 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗧𝘂𝗿𝗻 𝗼𝗳𝗳 𝗛𝗘𝗥𝗢𝗞𝗨 𝗗𝘆𝗻𝗼 𝗳𝗼𝗿 🎧𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗥𝗲𝗯𝗼𝗼𝘁 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝗺𝗮𝗻𝘂𝗮𝗹𝗹𝘆 𝗶𝗻 𝗛𝗘𝗥𝗢𝗞𝗨.
𝗙𝗶𝗻𝗱 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝗛𝗘𝗥𝗢𝗞𝗨 𝗱𝘆𝗻𝗼 𝘂𝘀𝗮𝗴𝗲
"""
𝗡𝗢𝗥𝗗Σ𝗗BΣ=f"""{ӼɛӼօ}`ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴏɴʟʏ ꜰᴏʀ ɴᴏʀᴅ ᴀᴅᴍɪɴꜱ ᴏꜰ ᴛʜᴇ ɢʀᴏᴜᴘꜱ ᴡʜᴇʀᴇ —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—ɪꜱ ᴘʟᴜɢɢᴇᴅ ɪɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.`
...
* FROM HERE THE MAIN CODE FOR —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••— BOT STARTS.
...
ΣOЯ: NordLink):
    try:
        try:
            ...
            norderror,
            caption=f"""{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n
    ...
    try:
        try:
            ...
            if HEROKU_API_KEY is not None and HEROKU_APP_NAME is not None:
                ...
                # await ΣOЯ.reply_photo(
                # photo=nordlinker,
                # caption=f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n  **𝗡𝗢𝗥𝗗Σ𝗗 𝙝𝙖𝙨 𝙘𝙡𝙚𝙖𝙣𝙚𝙙 𝙪𝙥 𝙖𝙣𝙙 𝙧𝙚𝙨𝙩𝙖𝙧𝙩𝙚𝙙 𝙞𝙩𝙨𝙚𝙡𝙛!**",
                # reply_markup=InlineKeyboardMarkup([[
                # InlineKeyboardButton(
                # text="🕊DΣV GЯӨЦP",
                # url=f"https://t.me/hypevoids",),],[
...
ΣOЯ: NordLink):
    try:
        try:
            ...
            photo=nordlinker,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n⚠️❗️  `𝗧𝘂𝗿𝗶𝗻𝗴 𝗢𝗳𝗳 𝗛𝗲𝗿𝗼𝗸𝘂 𝗗𝘆𝗻𝗼𝘀 𝗳𝗼𝗿 𝗡𝗢𝗥𝗗Σ𝗗©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿.\n𝗠𝗮𝗻𝘂𝗮𝗹𝗹𝘆 𝘁𝘂𝗿𝗻 𝗶𝘁 𝗼𝗻 𝘁𝗼 𝘀𝘁𝗮𝗿𝘁 𝗮𝗴𝗮𝗶𝗻.`")
            await asyncio.sleep(2)
            await shuts.delete()
...
#                 0][
#                 "views"]
#                 𝗡𝗢𝗥𝗗Σ𝗗_THUMBNAIL = f'𝗡𝗢𝗥𝗗Σ𝗗{ΣOЯ.message_id}.jpg'
#                 thumb = requests.get(
#                 thumbnail,
...
#             title=title,
#             duration=dur,
#             thumb=𝗡𝗢𝗥𝗗Σ𝗗_THUMBNAIL
#             )
#             await ADU.reply_photo(
#             photo=𝗡𝗢𝗥𝗗Σ𝗗_THUMBNAIL,
#             caption=NORN,
#             reply_markup=InlineKeyboardMarkup([[
#             InlineKeyboardButton(
#             text="🕊DΣV GЯӨЦP",
...
#             ]]))
#         except Exception as DΣD:
#             psychodelic = await ΣOЯ.reply_text(f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n❌ Error\n\n`{DΣD}`")
#             await psychodelic.delete()
#         try:
#             os.remove(audio_file)
#             os.remove(𝗡𝗢𝗥𝗗Σ𝗗_THUMBNAIL)
#         except Exception as DΣD:
...
ΣOЯ: NordLink):
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    0][
                    "views"]
                    𝗡𝗢𝗥𝗗Σ𝗗_THUMBNAIL = f'🎧•𝗡𝗢𝗥𝗗Σ𝗗•🎧 by 🔥ΉYPΣ VӨID LΛB🔥-𝗡𝗢𝗥𝗗Σ𝗗{ΣOЯ.message_id}.jpg'
                    thumb = requests.get(
                    thumbnail,
    ...
    """
                ...
                psychodelic = ΣOЯ.reply_text(f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n❌ Error\n\n`{DΣD}`")
                psychodelic.delete()
            try:
                os.remove(audio_file)
                os.remove(𝗡𝗢𝗥𝗗Σ𝗗_THUMBNAIL)
...
ΣOЯ: NordLink):
    try:
        try:
            ...
            f"""{ӼɛӼօ}
    🕊 {mntn} 🕊
    ⚠️`ʜꜱᴇᴇᴍꜱ ʟɪᴋᴇ` —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—`ʜᴀꜱ ɴᴏᴛ ʙᴇᴇɴ ᴘʟᴜɢɢᴇᴅ ʏᴇᴛ ᴀɴᴅ` **__{chat.title}__** `ʜᴀꜱ ɪᴛ'ꜱ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ/ᴄᴀʟʟ ɴᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ ʏᴇᴛ.`\n`ᴘʟᴇᴀꜱᴇ ᴀꜱᴋ ɴᴏʀᴅ-ᴀᴅᴍɪɴꜱ ᴏꜰ` **__{chat.title}__** `ᴛᴏ ᴛᴜʀɴ ɪᴛ ᴏɴ ꜰɪʀꜱᴛ ᴀɴᴅ ʀᴇᴛʀʏ` [/stream]
    """)
            await asyncio.sleep(
            CLEANER
            )
...
ΣOЯ: NordLink):
    try:
        try:
            ...
            f"""{ӼɛӼօ}
    🕊 {mntn} 🕊
    ⚠️`ꜱᴇᴇᴍꜱ ʟɪᴋᴇ` —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—`ʜᴀꜱ ɴᴏᴛ ʙᴇᴇɴ ᴘʟᴜɢɢᴇᴅ ʏᴇᴛ ᴀɴᴅ` **__{chat.title}__** `ʜᴀꜱ ɪᴛ'ꜱ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ/ᴄᴀʟʟ ɴᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ ʏᴇᴛ.`\n`ᴘʟᴇᴀꜱᴇ ᴀꜱᴋ ɴᴏʀᴅ-ᴀᴅᴍɪɴꜱ ᴏꜰ` **__{chat.title}__** `ᴛᴏ ᴛᴜʀɴ ɪᴛ ᴏɴ ꜰɪʀꜱᴛ ᴀɴᴅ ʀᴇᴛʀʏ` [/resume]
    """)
            await asyncio.sleep(
            CLEANER
            )
...
|
""""""—••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—
* FROM HERE THE CODE FOR —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••— SESSION_MAKER STARTS
—••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—"""'''
    ...
    **—••÷🧊 SΣSSIӨП_MΛKΣЯ 🧊÷••—** `by` 🚀🔥 ΉYPΣ VӨID LΛB 🔥🚀
    ...
    """,
        ...
        url="https://t.me/HYPEVOIDBOT")
            ...
            while True:
                number = await 𝗡𝗢𝗥𝗗Σ𝗗𝗕𝗢𝗧.ask(chat.id,PHONE_NUMBER_TEXT)
                if not number.text:
                    continue
    ...
    **—••÷🧊 SΣSSIӨП_MΛKΣЯ 🧊÷••—** `by` 🚀🔥 ΉYPΣ VӨID LΛB 🔥🚀
    ...
    """,
        ...
        url="https://t.me/HYPEVOIDBOT")
                    ...
                    HYPE_PASSCODE = await 𝗡𝗢𝗥𝗗Σ𝗗𝗕𝗢𝗧.ask(chat.id,f"**÷••>**",timeout=300)
...
|
""""""—••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—
* FROM HERE THE CODE FOR —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••— USERBOT STARTS....
GONNA BE LONG LOL
"""
@𝗡𝗢𝗥𝗗Σ𝗗.on_message(
filters.chat(
    ...
    try:
        ...
        try:
            if HEROKU_API_KEY is not None and HEROKU_APP_NAME is not None and HEROKU == "HEROKU":
                ...
                # await restart(f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\nREBOOTED")
                await wait.delete()
    ...
    try:
        ...
        try:
            ...
            if len(ռօʀɖքʟǟʏɛʀʟɨֆȶ) == 1:
                ...
                photo=nordlinker,
                caption=f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n`𝗣𝗹𝗲𝗮𝘀𝗲 𝘄𝗮𝗶𝘁 𝗳𝗼𝗿 —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—𝘁𝗼 𝗹𝗶𝗻𝗸 𝘄𝗶𝘁𝗵 𝘂𝘀𝗲𝗿𝗯𝗼𝘁 𝘀𝗲𝗿𝘃𝗲𝗿...`\n𝙂𝙧𝙚𝙖𝙩𝙚𝙧 𝙖𝙪𝙙𝙞𝙤 𝙨𝙞𝙯𝙚, 𝙢𝙤𝙧𝙚 𝙩𝙞𝙢𝙚 𝙩𝙤 𝙖𝙙𝙙 𝙩𝙤 𝙨𝙚𝙧𝙫𝙚𝙧",
                reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton(
                text="🕊DΣV GЯӨЦP",
                url=f"https://t.me/hypevoids",),],[
            ...
            try:
                ...
                NORD_TITLE = "🎶🌟𝗡𝗢𝗥𝗗Σ𝗗_SMΛЯƬ_MUSIC_PLΛYΣЯ"
                try:
                    chatID = ΣOЯ.chat.id
    ...
    try:
        try:
            ...
            if ռօʀɖʀɨռɢ and ռօʀɖʀɨռɢ.is_connected:
                ...
                psychodelic = await ΣOЯ.reply_photo(
                photo=nordlinker,
                caption=f"**𝗡𝗢𝗥𝗗Σ𝗗©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗶𝘀 𝗰𝘂𝗿𝗿𝗲𝗻𝘁𝗹𝘆 𝗶𝗻 𝘁𝗵𝗲 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁**:\n- **__{chat.title}__**",
                reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton(
                text="🕊DΣV GЯӨЦP",
                url=f"https://t.me/hypevoids",),],[
                ...
                photo=nordlinker,
                caption=f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n⚠️❗️ **𝗡𝗢𝗥𝗗Σ𝗗©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗱𝗶𝗱 𝗻𝗼𝘁 𝗷𝗼𝗶𝗻 𝗮𝗻𝘆 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁 𝘆𝗲𝘁",
                reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton(
                text="🕊DΣV GЯӨЦP",
                url=f"https://t.me/hypevoids",),],[
...
ΣOЯ: NordLink):
    try:
        try:
            ...
            psychodelic = await ΣOЯ.reply_photo(
            photo=nordlinker,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n⏹❗️ **𝗡𝗢𝗥𝗗Σ𝗗©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝘀𝘁𝗼𝗽𝗽𝗲𝗱 𝗽𝗹𝗮𝘆𝗶𝗻𝗴**",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
...
ΣOЯ: NordLink):
    try:
        try:
            ...
            psychodelic = await ΣOЯ.reply_photo(
            photo=nordlinker,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n⏹❗️ **𝗡𝗢𝗥𝗗Σ𝗗©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗶𝘀 𝗻𝗼𝘄 𝗽𝗹𝗮𝘆𝗶𝗻𝗴 𝗰𝘂𝗿𝗿𝗲𝗻𝘁 𝘀𝗼𝗻𝗴 𝗳𝗿𝗼𝗺 𝘁𝗵𝗲 𝗯𝗲𝗴𝗶𝗻𝗻𝗶𝗻𝗴...**",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
...
ΣOЯ: NordLink):
    try:
        try:
            ...
            psychodelic = await ΣOЯ.reply_photo(
            photo=nordlinker,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n **𝗡𝗢𝗥𝗗Σ𝗗©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗽𝗮𝘂𝘀𝗲𝗱 𝗰𝘂𝗿𝗿𝗲𝗻𝘁 𝗺𝘂𝘀𝗶𝗰 𝗶𝗻 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁**",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
...
ΣOЯ: NordLink):
    try:
        try:
            ...
            psychodelic = await ΣOЯ.reply_photo(
            photo=nordlinker,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n **𝗡𝗢𝗥𝗗Σ𝗗©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗿𝗲𝘀𝘂𝗺𝗲𝗱 𝗺𝘂𝘀𝗶𝗰 𝗶𝗻 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁**",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
...
ΣOЯ: NordLink):
    try:
        try:
            ...
            psychodelic = await ΣOЯ.reply_photo(
            photo=nordlinker,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ 𝗡𝗢𝗥𝗗Σ𝗗 ʊֆɛʀ  {mntn}\n **𝗡𝗢𝗥𝗗Σ𝗗©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗰𝗹𝗲𝗮𝗻𝗲𝗱 {count} 𝘁𝗲𝗺𝗽/𝗿𝗮𝘄 𝗳𝗶𝗹𝗲𝘀",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
...
|
""""""—••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—
* FROM HERE THE CODE FOR —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••— NORD_PLAYER STARTS
—••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—
"""
class NORDPLAYER(object):
    ...
    async def send_playlist(self):
        ...
        if not ռօʀɖքʟǟʏɛʀʟɨֆȶ:
            ...
            if len(ռօʀɖքʟǟʏɛʀʟɨֆȶ) == 1:
                NeoN = f"[🕊𝗡𝗢𝗥𝗗Σ𝗗 by ΉYPΣ VӨID LΛB](https://t.me/hypevoidbot)🎧𝗧𝗵𝗲𝗿𝗲 𝘄𝗲 𝗴𝗼 ♪"
            else:
                NeoN = f"[🕊𝗡𝗢𝗥𝗗Σ𝗗 by ΉYPΣ VӨID LΛB](https://t.me/hypevoidbot)🎧𝗧𝗵𝗲𝗿𝗲 𝘄𝗲 𝗴𝗼 ♪"
...
|
""""""—••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—
* FROM HERE THE CODE FOR —••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••— LOOGER USING LOGURU STARTS
—••÷[🕊𝗡𝗢𝗥𝗗Σ𝗗🕊]÷••—
"""
