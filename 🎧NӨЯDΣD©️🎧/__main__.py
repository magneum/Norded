...
COLOR_CODES =       "||________🟢=HEROKU STUFFS________||________🔵=—••÷[🕊NӨЯDΣD🕊]÷••—STUFFS________||________🟤=RADIO STUFFS________||"
import os
import io
from re import I
import sys
...
**{DYNO}norded** 
•♪ 𝘊𝘩𝘦𝘤𝘬 𝘸𝘩𝘦𝘳𝘦 𝘪𝘴 𝘵𝘩𝘦 —••÷[🕊NӨЯDΣD🕊]÷••—𝘶𝘴𝘦𝘳𝘣𝘰𝘵 𝘱𝘭𝘶𝘨𝘨𝘦𝘥.
**{DYNO}plug**   
•♪ —••÷[🕊NӨЯDΣD🕊]÷••—𝘑𝘰𝘪𝘯 𝘨𝘳𝘰𝘶𝘱 𝘷𝘰𝘪𝘤𝘦 𝘤𝘩𝘢𝘵.
**{DYNO}unplug** 
•♪ 𝘓𝘦𝘢𝘷𝘦 𝘵𝘩𝘦 𝘨𝘳𝘰𝘶𝘱 𝘷𝘰𝘪𝘤𝘦 𝘤𝘩𝘢𝘵 𝘸𝘩𝘦𝘳𝘦 —••÷[🕊NӨЯDΣD🕊]÷••—𝘸𝘢𝘴 𝘱𝘭𝘢𝘺𝘪𝘯𝘨.
**{DYNO}end**    
...
**{DYNO}restart**
•♪ 𝘙𝘦𝘣𝘰𝘰𝘵 —••÷[🕊NӨЯDΣD🕊]÷••—𝘮𝘢𝘯𝘶𝘢𝘭𝘭𝘺 𝘪𝘯 𝘏𝘌𝘙𝘖𝘒𝘜.
**{DYNO}usage**  
•♪ 𝘍𝘪𝘯𝘥 —••÷[🕊NӨЯDΣD🕊]÷••—𝘏𝘌𝘙𝘖𝘒𝘜 𝘥𝘺𝘯𝘰 𝘶𝘴𝘢𝘨𝘦
"""
...
𝐂𝐡𝐞𝐜𝐤 𝐰𝐡𝐞𝐫𝐞 𝐢𝐬 𝐭𝐡𝐞 —••÷[🕊NӨЯDΣD🕊]÷••—𝐮𝐬𝐞𝐫𝐛𝐨𝐭 𝐩𝐥𝐮𝐠𝐠𝐞𝐝
...
𝐑𝐞𝐛𝐨𝐨𝐭 —••÷[🕊NӨЯDΣD🕊]÷••—𝐦𝐚𝐧𝐮𝐚𝐥𝐥𝐲 𝐢𝐧 𝐇𝐄𝐑𝐎𝐊𝐔.
𝐅𝐢𝐧𝐝 —••÷[🕊NӨЯDΣD🕊]÷••—𝐇𝐄𝐑𝐎𝐊𝐔 𝐝𝐲𝐧𝐨 𝐮𝐬𝐚𝐠𝐞
...
𝗖𝗵𝗲𝗰𝗸 𝘄𝗵𝗲𝗿𝗲 𝗶𝘀 𝘁𝗵𝗲 —••÷[🕊NӨЯDΣD🕊]÷••—𝘂𝘀𝗲𝗿𝗯𝗼𝘁 𝗽𝗹𝘂𝗴𝗴𝗲𝗱
𝗝𝗼𝗶𝗻 𝗴𝗿𝗼𝘂𝗽 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁.
𝗟𝗲𝗮𝘃𝗲 𝘁𝗵𝗲 𝗴𝗿𝗼𝘂𝗽 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁 𝘄𝗵𝗲𝗿𝗲 —••÷[🕊NӨЯDΣD🕊]÷••—𝘄𝗮𝘀 𝗽𝗹𝗮𝘆𝗶𝗻𝗴.
...
𝗥𝗲𝗯𝗼𝗼𝘁 —••÷[🕊NӨЯDΣD🕊]÷••—𝗺𝗮𝗻𝘂𝗮𝗹𝗹𝘆 𝗶𝗻 𝗛𝗘𝗥𝗢𝗞𝗨.
𝗙𝗶𝗻𝗱 —••÷[🕊NӨЯDΣD🕊]÷••—𝗛𝗘𝗥𝗢𝗞𝗨 𝗱𝘆𝗻𝗼 𝘂𝘀𝗮𝗴𝗲
"""
NӨЯDΣDBΣ=f"""{ӼɛӼօ}`ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴏɴʟʏ ꜰᴏʀ ɴᴏʀᴅ ᴀᴅᴍɪɴꜱ ᴏꜰ ᴛʜᴇ ɢʀᴏᴜᴘꜱ ᴡʜᴇʀᴇ —••÷[🕊NӨЯDΣD🕊]÷••—ɪꜱ ᴘʟᴜɢɢᴇᴅ ɪɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.`
...
ɳɾԃ: NordLink):
    ...
    try:
        ...
        if len(ռօʀɖքʟǟʏɛʀʟɨֆȶ) == 1:
            ...
            animation=nordanimer,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ NӨЯDΣD ʊֆɛʀ  {mntn}\n`𝗣𝗹𝗲𝗮𝘀𝗲 𝘄𝗮𝗶𝘁 𝗳𝗼𝗿 —••÷[🕊NӨЯDΣD🕊]÷••—𝘁𝗼 𝗹𝗶𝗻𝗸 𝘄𝗶𝘁𝗵 𝘂𝘀𝗲𝗿𝗯𝗼𝘁 𝘀𝗲𝗿𝘃𝗲𝗿...`\n𝙂𝙧𝙚𝙖𝙩𝙚𝙧 𝙖𝙪𝙙𝙞𝙤 𝙨𝙞𝙯𝙚, 𝙢𝙤𝙧𝙚 𝙩𝙞𝙢𝙚 𝙩𝙤 𝙖𝙙𝙙 𝙩𝙤 𝙨𝙚𝙧𝙫𝙚𝙧",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
        ...
        try:
            ...
            NORD_TITLE = "🎶🌟NӨЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ"
            try:
                chatID = ɳɾԃ.chat.id
...
ɳɾԃ: NordLink):
    try:
        ...
        f"""{ӼɛӼօ}
🕊 {mntn} 🕊
⚠️`ʜꜱᴇᴇᴍꜱ ʟɪᴋᴇ` —••÷[🕊NӨЯDΣD🕊]÷••—`ʜᴀꜱ ɴᴏᴛ ʙᴇᴇɴ ᴘʟᴜɢɢᴇᴅ ʏᴇᴛ ᴀɴᴅ` **__{chat.title}__** `ʜᴀꜱ ɪᴛ'ꜱ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ/ᴄᴀʟʟ ɴᴏᴛ ᴄᴏɴɴᴇᴄᴛᴇᴅ ʏᴇᴛ.`\n`ᴘʟᴇᴀꜱᴇ ᴀꜱᴋ ɴᴏʀᴅ-ᴀᴅᴍɪɴꜱ ᴏꜰ` **__{chat.title}__** `ᴛᴏ ᴛᴜʀɴ ɪᴛ ᴏɴ ꜰɪʀꜱᴛ ᴀɴᴅ ʀᴇᴛʀʏ` [/stream]
""")
        await asyncio.sleep(
        CLEANER
        )
