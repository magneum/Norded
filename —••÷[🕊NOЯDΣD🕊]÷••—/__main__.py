...
COLOR_CODES =       "||________🟢=HEROKU STUFFS________||________🔵=—••÷[🕊NOЯDΣD🕊]÷••—STUFFS________||________🟤=RADIO STUFFS________||"
import os
import io
from re import I
import sys
...
**{DYNO}stream**
•♪ 𝘙𝘦𝘱𝘭𝘺 𝘵𝘰 𝘢𝘶𝘥𝘪𝘰 𝘧𝘪𝘭𝘦 𝘵𝘰 𝘱𝘭𝘢𝘺/𝘲𝘶𝘦𝘶𝘦 𝘵𝘰 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}stream**
•♪ 𝘜𝘴𝘦 𝘵𝘰 𝘤𝘩𝘦𝘤𝘬𝘰𝘶𝘵 𝘵𝘩𝘦 𝘱𝘭𝘢𝘺𝘭𝘪𝘴𝘵 𝘰𝘧 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}ping**   
•♪ 𝘊𝘩𝘦𝘤𝘬 𝘵𝘩𝘦 𝘱𝘪𝘯𝘨 𝘴𝘵𝘢𝘵𝘶𝘴 𝘰𝘧 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}license**
•♪ 𝘊𝘩𝘦𝘤𝘬 𝘭𝘪𝘤𝘦𝘯𝘴𝘦 𝘰𝘧 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}yt**
•♪ __Direct youtube music download and play with 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.__
"""
...
**{DYNO}norded** 
•♪ 𝘊𝘩𝘦𝘤𝘬 𝘸𝘩𝘦𝘳𝘦 𝘪𝘴 𝘵𝘩𝘦 —••÷[🕊NOЯDΣD🕊]÷••—𝘶𝘴𝘦𝘳𝘣𝘰𝘵 𝘱𝘭𝘶𝘨𝘨𝘦𝘥.
**{DYNO}plug**   
•♪ —••÷[🕊NOЯDΣD🕊]÷••—𝘑𝘰𝘪𝘯 𝘨𝘳𝘰𝘶𝘱 𝘷𝘰𝘪𝘤𝘦 𝘤𝘩𝘢𝘵.
**{DYNO}unplug** 
•♪ 𝘓𝘦𝘢𝘷𝘦 𝘵𝘩𝘦 𝘨𝘳𝘰𝘶𝘱 𝘷𝘰𝘪𝘤𝘦 𝘤𝘩𝘢𝘵 𝘸𝘩𝘦𝘳𝘦 —••÷[🕊NOЯDΣD🕊]÷••—𝘸𝘢𝘴 𝘱𝘭𝘢𝘺𝘪𝘯𝘨.
**{DYNO}end**    
...
**{DYNO}temp**   
•♪ 𝘊𝘭𝘦𝘢𝘯 𝘵𝘦𝘮𝘱 𝘢𝘶𝘥𝘪𝘰 𝘧𝘪𝘭𝘦𝘴 𝘪𝘯 𝘴𝘦𝘳𝘷𝘦𝘳 𝘰𝘧 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
"""
...
**{DYNO}shutdown**
•♪ 𝘛𝘶𝘳𝘯 𝘰𝘧𝘧 𝘏𝘌𝘙𝘖𝘒𝘜 𝘋𝘺𝘯𝘰 𝘧𝘰𝘳 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
**{DYNO}restart**
•♪ 𝘙𝘦𝘣𝘰𝘰𝘵 —••÷[🕊NOЯDΣD🕊]÷••—𝘮𝘢𝘯𝘶𝘢𝘭𝘭𝘺 𝘪𝘯 𝘏𝘌𝘙𝘖𝘒𝘜.
**{DYNO}usage**  
•♪ 𝘍𝘪𝘯𝘥 —••÷[🕊NOЯDΣD🕊]÷••—𝘏𝘌𝘙𝘖𝘒𝘜 𝘥𝘺𝘯𝘰 𝘶𝘴𝘢𝘨𝘦
"""
...
""",
    ...
    url="https://t.me/HYPEVOIDBOT")
        ...
        while True:
            number = await NӨЯDBӨƬ.ask(chat.id,PHONE_NUMBER_TEXT)
            if not number.text:
                continue
...
""",
    ...
    url="https://t.me/HYPEVOIDBOT")
                ...
                HYPE_PASSCODE = await NӨЯDBӨƬ.ask(chat.id,f"**÷••>**",timeout=300)
...
"""
𝐑𝐞𝐩𝐥𝐲 𝐭𝐨 𝐚𝐮𝐝𝐢𝐨 𝐟𝐢𝐥𝐞 𝐭𝐨 𝐩𝐥𝐚𝐲/𝐪𝐮𝐞𝐮𝐞 𝐭𝐨 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐔𝐬𝐞 𝐭𝐨 𝐜𝐡𝐞𝐜𝐤𝐨𝐮𝐭 𝐭𝐡𝐞 𝐩𝐥𝐚𝐲𝐥𝐢𝐬𝐭 𝐨𝐟 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐂𝐡𝐞𝐜𝐤 𝐭𝐡𝐞 𝐩𝐢𝐧𝐠 𝐬𝐭𝐚𝐭𝐮𝐬 𝐨𝐟 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️. 
𝐂𝐡𝐞𝐜𝐤 𝐥𝐢𝐜𝐞𝐧𝐬𝐞 𝐨𝐟 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐂𝐡𝐞𝐜𝐤 𝐰𝐡𝐞𝐫𝐞 𝐢𝐬 𝐭𝐡𝐞 —••÷[🕊NOЯDΣD🕊]÷••—𝐮𝐬𝐞𝐫𝐛𝐨𝐭 𝐩𝐥𝐮𝐠𝐠𝐞𝐝
𝐉𝐨𝐢𝐧 𝐠𝐫𝐨𝐮𝐩 𝐯𝐨𝐢𝐜𝐞 𝐜𝐡𝐚𝐭.
𝐋𝐞𝐚𝐯𝐞 𝐭𝐡𝐞 𝐠𝐫𝐨𝐮𝐩 𝐯𝐨𝐢𝐜𝐞 𝐜𝐡𝐚𝐭 𝐰𝐡𝐞𝐫𝐞 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️. 𝐰𝐚𝐬 𝐩𝐥𝐚𝐲𝐢𝐧𝐠.
...
𝐂𝐥𝐞𝐚𝐧 𝐭𝐞𝐦𝐩 𝐚𝐮𝐝𝐢𝐨 𝐟𝐢𝐥𝐞𝐬 𝐢𝐧 𝐬𝐞𝐫𝐯𝐞𝐫 𝐨𝐟 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐓𝐮𝐫𝐧 𝐨𝐟𝐟 𝐇𝐄𝐑𝐎𝐊𝐔 𝐃𝐲𝐧𝐨 𝐟𝐨𝐫 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝐑𝐞𝐛𝐨𝐨𝐭 —••÷[🕊NOЯDΣD🕊]÷••—𝐦𝐚𝐧𝐮𝐚𝐥𝐥𝐲 𝐢𝐧 𝐇𝐄𝐑𝐎𝐊𝐔.
𝐅𝐢𝐧𝐝 —••÷[🕊NOЯDΣD🕊]÷••—𝐇𝐄𝐑𝐎𝐊𝐔 𝐝𝐲𝐧𝐨 𝐮𝐬𝐚𝐠𝐞

𝗥𝗲𝗽𝗹𝘆 𝘁𝗼 𝗮𝘂𝗱𝗶𝗼 𝗳𝗶𝗹𝗲 𝘁𝗼 𝗽𝗹𝗮𝘆/𝗾𝘂𝗲𝘂𝗲 𝘁𝗼 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗨𝘀𝗲 𝘁𝗼 𝗰𝗵𝗲𝗰𝗸𝗼𝘂𝘁 𝘁𝗵𝗲 𝗽𝗹𝗮𝘆𝗹𝗶𝘀𝘁 𝗼𝗳 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗖𝗵𝗲𝗰𝗸 𝘁𝗵𝗲 𝗽𝗶𝗻𝗴 𝘀𝘁𝗮𝘁𝘂𝘀 𝗼𝗳 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗖𝗵𝗲𝗰𝗸 𝗹𝗶𝗰𝗲𝗻𝘀𝗲 𝗼𝗳 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗖𝗵𝗲𝗰𝗸 𝘄𝗵𝗲𝗿𝗲 𝗶𝘀 𝘁𝗵𝗲 —••÷[🕊NOЯDΣD🕊]÷••—𝘂𝘀𝗲𝗿𝗯𝗼𝘁 𝗽𝗹𝘂𝗴𝗴𝗲𝗱
𝗝𝗼𝗶𝗻 𝗴𝗿𝗼𝘂𝗽 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁.
𝗟𝗲𝗮𝘃𝗲 𝘁𝗵𝗲 𝗴𝗿𝗼𝘂𝗽 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁 𝘄𝗵𝗲𝗿𝗲 —••÷[🕊NOЯDΣD🕊]÷••—𝘄𝗮𝘀 𝗽𝗹𝗮𝘆𝗶𝗻𝗴.
...
𝗖𝗹𝗲𝗮𝗻 𝘁𝗲𝗺𝗽 𝗮𝘂𝗱𝗶𝗼 𝗳𝗶𝗹𝗲𝘀 𝗶𝗻 𝘀𝗲𝗿𝘃𝗲𝗿 𝗼𝗳 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗧𝘂𝗿𝗻 𝗼𝗳𝗳 𝗛𝗘𝗥𝗢𝗞𝗨 𝗗𝘆𝗻𝗼 𝗳𝗼𝗿 🎧NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ©️.
𝗥𝗲𝗯𝗼𝗼𝘁 —••÷[🕊NOЯDΣD🕊]÷••—𝗺𝗮𝗻𝘂𝗮𝗹𝗹𝘆 𝗶𝗻 𝗛𝗘𝗥𝗢𝗞𝗨.
𝗙𝗶𝗻𝗱 —••÷[🕊NOЯDΣD🕊]÷••—𝗛𝗘𝗥𝗢𝗞𝗨 𝗱𝘆𝗻𝗼 𝘂𝘀𝗮𝗴𝗲
"""
NOЯDΣDBΣ=f"""{ӼɛӼօ}`ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴏɴʟʏ ꜰᴏʀ ɴᴏʀᴅ ᴀᴅᴍɪɴꜱ ᴏꜰ ᴛʜᴇ ɢʀᴏᴜᴘꜱ ᴡʜᴇʀᴇ —••÷[🕊NOЯDΣD🕊]÷••—ɪꜱ ᴘʟᴜɢɢᴇᴅ ɪɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ.`
...
async def Nord_Verity(_, __, ɳɾԃ: NordLink):
    if ɳɾԃ.from_user.id in NORD_ADMINS:
        return True
    return False
...
async def Nord_Connected(_, __, ɳɾԃ: NordLink):
...
async def Nord_Ghost_Filter(_, __, ɳɾԃ: NordLink):
    return bool(
    ɳɾԃ.from_user is None 
    and ɳɾԃ.sender_chat)
...
ɳɾԃ: NordLink):
    ...
    try:
        ...
        elif ɳɾԃ.reply_to_message and ɳɾԃ.reply_to_message.audio:
        ...
        if len(ռօʀɖքʟǟʏɛʀʟɨֆȶ) == 1:
            ...
            animation=nordanimer,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ NOЯDΣD ʊֆɛʀ  {mntn}\n`𝗣𝗹𝗲𝗮𝘀𝗲 𝘄𝗮𝗶𝘁 𝗳𝗼𝗿 —••÷[🕊NOЯDΣD🕊]÷••—𝘁𝗼 𝗹𝗶𝗻𝗸 𝘄𝗶𝘁𝗵 𝘂𝘀𝗲𝗿𝗯𝗼𝘁 𝘀𝗲𝗿𝘃𝗲𝗿...`\n𝙂𝙧𝙚𝙖𝙩𝙚𝙧 𝙖𝙪𝙙𝙞𝙤 𝙨𝙞𝙯𝙚, 𝙢𝙤𝙧𝙚 𝙩𝙞𝙢𝙚 𝙩𝙤 𝙖𝙙𝙙 𝙩𝙤 𝙨𝙚𝙧𝙫𝙚𝙧",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
        ...
        try:
            async for YΣ in client.search_messages(
                ...
                if YΣ.audio:
                    await YΣ.unpin()
            await ɳɾԃ.reply_to_message.pin(True)
            NORD_TITLE = "🎶🌟NOЯDΣD_SMΛЯƬ_MUSIC_PLΛYΣЯ"
            try:
                chatID = ɳɾԃ.chat.id
...
ɳɾԃ: NordLink):
    ...
    try:
        await ɳɾԃ.delete()
        ռօʀɖքʟǟʏɛʀʟɨֆȶ = ռօʀɖɦօք.ռօʀɖքʟǟʏɛʀʟɨֆȶ
        if len(ɳɾԃ.command) == 1:
            await NorDIgnoreNow()
        else:
            try:
                items = list(dict.fromkeys(ɳɾԃ.command[1:]))
...
ɳɾԃ: NordLink):
    try:
        mntn = ɳɾԃ.from_user.mention
        if cb_data is False:
            await ɳɾԃ.reply_text(f"Add @{BOT_USERNAME} to group")
        else:
            await ɳɾԃ.delete()
    except Exception as Σ:
        zygote = await ɳɾԃ.reply_animation(
...
ɳɾԃ: NordLink):
    try:
        ...
        if ռօʀɖʀɨռɢ and ռօʀɖʀɨռɢ.is_connected:
            ...
            psychodelic = await ɳɾԃ.reply_animation(
            animation=nordanimer,
            caption=f"**NOЯDΣD©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗶𝘀 𝗰𝘂𝗿𝗿𝗲𝗻𝘁𝗹𝘆 𝗶𝗻 𝘁𝗵𝗲 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁**:\n- **__{chat.title}__**",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
            ...
            animation=nordanimer,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ NOЯDΣD ʊֆɛʀ  {mntn}\n⚠️❗️ **NOЯDΣD©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗱𝗶𝗱 𝗻𝗼𝘁 𝗷𝗼𝗶𝗻 𝗮𝗻𝘆 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁 𝘆𝗲𝘁",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
...
ɳɾԃ: NordLink):
    try:
        ...
        psychodelic = await ɳɾԃ.reply_animation(
        animation=nordanimer,
        caption=f"{ӼɛӼօ} 👾 Hɛʏ NOЯDΣD ʊֆɛʀ  {mntn}\n⏹❗️ **NOЯDΣD©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝘀𝘁𝗼𝗽𝗽𝗲𝗱 𝗽𝗹𝗮𝘆𝗶𝗻𝗴**",
        reply_markup=InlineKeyboardMarkup([[
        InlineKeyboardButton(
        text="🕊DΣV GЯӨЦP",
        url=f"https://t.me/hypevoids",),],[
        ...
        try:
            async for YΣ in client.search_messages(ɳɾԃ.chat.id,filter="pinned",limit=1):
                if YΣ.audio:
                    await YΣ.unpin()
        except ChatAdminRequired:
            pass
...
ɳɾԃ: NordLink):
    try:
        ...
        psychodelic = await ɳɾԃ.reply_animation(
        animation=nordanimer,
        caption=f"{ӼɛӼօ} 👾 Hɛʏ NOЯDΣD ʊֆɛʀ  {mntn}\n⏹❗️ **NOЯDΣD©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗶𝘀 𝗻𝗼𝘄 𝗽𝗹𝗮𝘆𝗶𝗻𝗴 𝗰𝘂𝗿𝗿𝗲𝗻𝘁 𝘀𝗼𝗻𝗴 𝗳𝗿𝗼𝗺 𝘁𝗵𝗲 𝗯𝗲𝗴𝗶𝗻𝗻𝗶𝗻𝗴...**",
        reply_markup=InlineKeyboardMarkup([[
        InlineKeyboardButton(
        text="🕊DΣV GЯӨЦP",
        url=f"https://t.me/hypevoids",),],[
...
ɳɾԃ: NordLink):
    try:
        ...
        psychodelic = await ɳɾԃ.reply_animation(
        animation=nordanimer,
        caption=f"{ӼɛӼօ} 👾 Hɛʏ NOЯDΣD ʊֆɛʀ  {mntn}\n **NOЯDΣD©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗽𝗮𝘂𝘀𝗲𝗱 𝗰𝘂𝗿𝗿𝗲𝗻𝘁 𝗺𝘂𝘀𝗶𝗰 𝗶𝗻 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁**",
        reply_markup=InlineKeyboardMarkup([[
        InlineKeyboardButton(
        text="🕊DΣV GЯӨЦP",
        url=f"https://t.me/hypevoids",),],[
...
ɳɾԃ: NordLink):
    try:
        ...
        psychodelic = await ɳɾԃ.reply_animation(
        animation=nordanimer,
        caption=f"{ӼɛӼօ} 👾 Hɛʏ NOЯDΣD ʊֆɛʀ  {mntn}\n **NOЯDΣD©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗿𝗲𝘀𝘂𝗺𝗲𝗱 𝗺𝘂𝘀𝗶𝗰 𝗶𝗻 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁**",
        reply_markup=InlineKeyboardMarkup([[
        InlineKeyboardButton(
        text="🕊DΣV GЯӨЦP",
        url=f"https://t.me/hypevoids",),],[
...
ɳɾԃ: NordLink):
    try:
        ...
        psychodelic = await ɳɾԃ.reply_animation(
        animation=nordanimer,
        caption=f"{ӼɛӼօ} 👾 Hɛʏ NOЯDΣD ʊֆɛʀ  {mntn}\n **NOЯDΣD©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿 𝗰𝗹𝗲𝗮𝗻𝗲𝗱 {count} 𝘁𝗲𝗺𝗽/𝗿𝗮𝘄 𝗳𝗶𝗹𝗲𝘀",
        reply_markup=InlineKeyboardMarkup([[
        InlineKeyboardButton(
        text="🕊DΣV GЯӨЦP",
        url=f"https://t.me/hypevoids",),],[
...
async def ռօʀɖɖօառʟօǟɖɛʀ(ɳɾԃ: NordLink):
    ռօʀɖʀɨռɢ = ռօʀɖɦօք.ռօʀɖʀɨռɢ
    client = ռօʀɖʀɨռɢ.client
    raw_file = os.path.join(
    client.workdir,
    DEFAULT_DOWNLOAD_DIR,
    f"{ɳɾԃ.audio.file_unique_id}.raw")
    if not os.path.isfile(raw_file):
        original_file = await ɳɾԃ.download()
...
ɳɾԃ: NordLink):
    try:
        try:
            PERM = await ɳɾԃ.reply_text("**CHECKING BOT PERMISSIONS.........**")
...
ɳɾԃ: NordLink):
    try:
        ...
        if HEROKU_API_KEY is not None and HEROKU_APP_NAME is not None:
            ...
            await ɳɾԃ.reply_animation(
            animation=nordanimer,
            caption=f"{ӼɛӼօ} 👾 Hɛʏ NOЯDΣD ʊֆɛʀ  {mntn}\n  **NOЯDΣD 𝙝𝙖𝙨 𝙘𝙡𝙚𝙖𝙣𝙚𝙙 𝙪𝙥 𝙖𝙣𝙙 𝙧𝙚𝙨𝙩𝙖𝙧𝙩𝙚𝙙 𝙞𝙩𝙨𝙚𝙡𝙛!**",
            reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton(
            text="🕊DΣV GЯӨЦP",
            url=f"https://t.me/hypevoids",),],[
...
ɳɾԃ: NordLink):
    try:
        ...
        animation=nordanimer,
        caption=f"{ӼɛӼօ} 👾 Hɛʏ NOЯDΣD ʊֆɛʀ  {mntn}\n⚠️❗️  `𝗧𝘂𝗿𝗶𝗻𝗴 𝗢𝗳𝗳 𝗛𝗲𝗿𝗼𝗸𝘂 𝗗𝘆𝗻𝗼𝘀 𝗳𝗼𝗿 NOЯDΣD©️ 𝗺𝘂𝘀𝗶𝗰 𝗽𝗹𝗮𝘆𝗲𝗿.\n𝗠𝗮𝗻𝘂𝗮𝗹𝗹𝘆 𝘁𝘂𝗿𝗻 𝗶𝘁 𝗼𝗻 𝘁𝗼 𝘀𝘁𝗮𝗿𝘁 𝗮𝗴𝗮𝗶𝗻.`")
        await asyncio.sleep(2)
        await shuts.delete()
...
#                 0][
#                 "views"]
#                 NOЯDΣD_THUMBNAIL = f'NOЯDΣD{ɳɾԃ.message_id}.jpg'
#                 thumb = requests.get(
#                 thumbnail,
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                0][
                "views"]
                NOЯDΣD_THUMBNAIL = f'🎧•NOЯDΣD•🎧 by 🔥ΉYPΣ VӨID LΛB🔥-NOЯDΣD{ɳɾԃ.message_id}.jpg'
                thumb = requests.get(
                thumbnail,
