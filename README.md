...
<p align="centre"><img  width="30%" height="30%" img src="worklord/NORD_USER.jpg" /></p>

## 🎧NӨЯDΣD©️🎧 Help Query:
<p align="centre"><img  width="30%" height="30%" img src="worklord/NORD_HELP.jpg" /></p>

## 🎧NӨЯDΣD©️🎧 Music Player:
<p align="centre"><img  width="30%" height="30%" img src="worklord/NORD_PLAYER.jpg" /></p>

## 🎧NӨЯDΣD©️🎧 YouTube Downloader:
<p align="centre"><img  width="30%" height="30%" img src="worklord/NORD_DOWNLOADER.jpg" /></p>
...
⇜⊷°•♪  𝗠𝗲𝗺𝗯𝗲𝗿_𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀  ♪•°⊶⇝
•♪ `{DYNO}sing`  ⇝Rᴇᴘʟʏ ᴡɪᴛʜ ᴀɴ ᴀᴜᴅɪᴏ ᴛᴏ ᴘʟᴀʏ/Qᴜᴇᴜᴇ ɪᴛ.
•♪ `{DYNO}sing`  ⇝Aʟꜱᴏ ᴜꜱᴇᴅ ᴛᴏ ᴄʜᴇᴄᴋ ᴘʟᴀʏʟɪꜱᴛ
•♪ `{DYNO}xero`⇝Tᴏ ᴄʜᴇᴄᴋ ᴛʜᴇ ᴘɪɴɢ ꜱᴛᴀᴛᴜꜱ ᴡɪᴛʜ ꜱᴇʀᴠᴇʀ.

⇜⊷°•♪  𝗔𝗱𝗺𝗶𝗻 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀  ♪•°⊶⇝
•♪ `{DYNO}group` ⇝Gᴇᴛ ᴛʜᴇ ᴠᴄ ɴᴀᴍᴇ ᴡʜᴇʀᴇ ɪꜰ ʙᴏᴛ ʜᴀꜱ ᴊᴏɪɴᴇᴅ.
•♪ `{DYNO}plug`  ⇝Cᴏᴍᴍᴀɴᴅ ʟɪᴋᴇ ᴀ ʙᴏꜱꜱ ᴛᴏ ᴊᴏɪɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴏꜰ ᴄᴜʀʀᴇɴᴛ ɢʀᴏᴜᴘ.
•♪ `{DYNO}exit`  ⇝Lᴇᴀᴠᴇ ᴄᴜʀʀᴇɴᴛ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴡʜᴇʀᴇ ɪꜱ ᴅᴊɪɴɢ.
•♪ `{DYNO}end`   ⇝Eɴᴅ ᴛʜᴇ ᴘʟᴀʏʟɪꜱᴛ ᴀɴᴅ ꜱᴛᴏᴘ ᴀʟʟ ᴍᴜꜱɪᴄ.
•♪ `{DYNO}pause` ⇝Pᴀᴜꜱᴇ!.
•♪ `{DYNO}resume`⇝Rᴇꜱᴜᴍᴇ!.
•♪ `{DYNO}replay`⇝Pʟᴀʏ ꜰʀᴏᴍ ᴛʜᴇ ʙᴇɢɪɴɴɪɴɢ ᴏꜰ ᴄᴜʀʀᴇɴᴛ ᴍᴜꜱɪᴄ ʙᴇɪɴɢ ᴘʟᴀʏᴇᴅ.
•♪ `{DYNO}next`  ⇝Sᴋɪᴘ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴍᴜꜱɪᴄ ᴏʀ ᴅᴇʟᴇᴛᴇ ᴀ ᴍᴜꜱɪᴄ ꜰʀᴏᴍ ᴘʟᴀʏʟɪꜱᴛ ʟɪᴋᴇ "skip 2".
•♪ `{DYNO}clear` ⇝Cʟᴇᴀɴ ᴛʜᴇ ᴛᴇᴍᴘ ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ᴍᴜꜱɪᴄ ʙʏ ʙᴏᴛc. 
•♪ `{DYNO}vol`   ⇝Cʜᴀɴɢᴇ ᴛʜᴇ ᴠᴏʟᴜᴍᴇ. ʟɪᴍɪᴛ 1-200

⇜⊷°•♪  𝗛𝗲𝗿𝗼𝗸𝘂 𝗔𝗱𝗺𝗶𝗻 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀  ♪•°⊶⇝
•♪ `{DYNO}shutdown ⇝Tᴜʀɴ ᴏꜰꜰ xᴇʀᴏɴᴏɪᴅʙᴏᴛ ᴀɴᴅ xᴇʀᴏɴᴏɪᴅᴜꜱᴇʀʙᴏᴛ ɪɴ ʜᴇʀᴏᴋᴜ
•♪ `{DYNO}restart  ⇝Rᴇʙᴏᴏᴛ xᴇʀᴏɴᴏɪᴅʙᴏᴛ ᴀɴᴅ xᴇʀᴏɴᴏɪᴅᴜꜱᴇʀʙᴏᴛ ɪɴ ʜᴇʀᴏᴋᴜ
•♪ `{DYNO}usage    ⇝Fɪɴᴅ ᴅʏɴᴏ ᴜꜱᴀɢᴇ ᴏꜰ xᴇʀᴏɴᴏɪᴅʙᴏᴛ ᴀɴᴅ xᴇʀᴏɴᴏɪᴅᴜꜱᴇʀʙᴏᴛ ɪɴ ʜᴇʀᴏᴋᴜ
```
