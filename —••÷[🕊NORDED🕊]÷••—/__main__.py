...
ΣOЯ: NordLink):
    try:
        try:
            ...
            photo=nordlinker,
            caption=f"""{ӼɛӼօ} Hey 𝙽𝙾𝚁𝙳𝙴𝙳 User 🍾:  {mntn}\n
**I am** [🔹 𝗡Ө𝗥𝗗Σ𝗗_𝗣LΛ𝗬Σ𝗥 🔹](https://telegra.ph/file/0592f028e92ff2a8e73f0.jpg) 
**for playing music in the voice chats of Telegram Groups & Channels**.
...
⚠️❗️   Seems like your 𝗛𝗘𝗥𝗢𝗞𝗨_𝗔𝗣𝗜_𝗞𝗘𝗬 is either empty ot wrong.
...
⚠️❗️   Seems like your 𝗛𝗘𝗥𝗢𝗞𝗨_𝗔𝗣𝗣_𝗡𝗔𝗠𝗘 is either empty ot wrong.
...
⚠️❗️   Seems like your 𝗛𝗘𝗥𝗢𝗞𝗨_𝗔𝗣𝗜_𝗞𝗘𝗬 𝗮𝗻𝗱 𝗛𝗘𝗥𝗢𝗞𝗨_𝗔𝗣𝗣_𝗡𝗔𝗠𝗘 is either empty ot wrong.
    ...
    try:
        ...
        try:
            if HEROKU_API_KEY is not None and HEROKU_APP_NAME is not None and HEROKU == "HEROKU":
                ...
                # await restart(f"{ӼɛӼօ} Hey 𝙽𝙾𝚁𝙳𝙴𝙳 User 🍾:  {mntn}\nREBOOTED")
                await wait.delete()
